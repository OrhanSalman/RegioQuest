...
struct HomeView: View {
    ...
    @State private var region = MKCoordinateRegion(
        //      center: CLLocationCoordinate2D(latitude: 50.874886, longitude: 8.025132),
            ...
            ScrollView {
                VStack {
                    ...
                    ZStack(alignment: .top) {
                        LinearGradient(gradient: Gradient(colors: [.primary, .blue]), startPoint: .top, endPoint: .bottom)
                            .mask {
                        ...
                        //                            .padding(.vertical)
                            ...
                            .shadow(color: .gray.opacity(0.5), radius: 18, x: 0, y: -40)
                        VStack {
                            HStack(spacing: 20) {
                                    ...
                                    .overlay {
                                        VStack(spacing: 20) {
                                            Image(systemName: "paperplane")
                                                .imageScale(.large)
                                            Text("Karte")
                                                .font(Font(UIFont.systemFont(ofSize: 12, weight: .thin, width: .expanded)))
                                        }
                                    }
                            ...
                            .padding(20)
                            .frame(width: UIScreen.main.bounds.width * 0.75, height: UIScreen.main.bounds.height * 0.23)
                            .clipped()
